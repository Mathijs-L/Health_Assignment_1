...
```
## Market power
From the calculated LOCI we can conclude that Hospital 4 has a high amount of market power since the LOCI is below 0.45.
...
- An example of abuse of market power would be charging higher prices to insurers than other hospitals who are competitive. A way to limit a hospital in abusing their market power through prices would be by introducing a system much like the NZA in the Netherlands. 
where healthcare providers have to declare rates as prescribed by the NZA.